          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                ...
                <form class="form-horizontal form-label-left" action="../../php/BorrarCuenta.php" method="post">
                  <span class="section" style="text-align: center;">Borrar Cuenta</span>
                  <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Nombre de usuario
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                      <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="NombreUsuario" required="required" type="text" value="<?php echo ObtenerDatos($_SESSION['Usuario'],'NombreUsuario'); ?>" readonly >
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" name="Contrasena" required="required" class="form-control col-md-7 col-xs-12" placeholder="Contraseña">
                        </div>
                      </div>                      
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <input type="submit" name="BorrarCuentar" value="BorrarCuenta" class="btn btn-danger">
                      </div>
                  </div>
                </form>
          </div>
