...
<section class="module">
           ...
           <div class="x_panel">
                  <div class="x_title">
                    <h2>Crear Anuncios <small></small></h2>
                  ...
                  <div class="x_content">
					...
					<form action="../../php/ActualizarFoto.php" method="post" enctype="multipart/form-data">
						Selecciona una foto para el Anuncio..<input type="File" name="Archivo" id="upload">
					...
					<form class="form-horizontal form-label-left input_mask">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" placeholder="Nombre del Anuncio">
                        
                        <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                      </div>
                      <p></p>
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" placeholder="Link del Anuncio">
               ...
               <div class="btn-group">
                    ...
                    <div class="form-group">
                      <textarea class="form-control" rows="7" id="message" name="message" placeholder="Descripcion de la Actividad*" required="required" data-validation-required-message="Please enter your message."></textarea>
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" class="btn btn-success">Subir Anuncio</button>
                        </div>
                      </div>
